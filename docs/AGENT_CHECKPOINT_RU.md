...
Новый Wi-Fi app SHA-256
`3f0ee467e9d127d5f3ac2d809c41b9809831098c729debaa0ea81b1f884fd836`
пока ожидает независимую проверку и установку. Профиль, ключ, backup и журналы
сохранены только локально; source review не заменяет физическую приёмку.

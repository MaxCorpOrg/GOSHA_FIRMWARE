## 14 сентября: кандидат восстановления обычных движений
...
Текущий app `9ba5e327…fdfb4` из `a63ac87`; физическая проверка ходьбы
владельцем ожидается. `8df041e3…cdf55d` сохранён для отката.

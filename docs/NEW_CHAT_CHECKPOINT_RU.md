...
- Стадия: отдельный неблокирующий канал событий прошивки для общего контура собран канонически для `gosha-v1`.
- Независимая проверка ИИ-офиса завершена без P0/P1/P2.
- Следующий шаг: живой прогон только после контролируемого развёртывания платформы; до этого устройство не прошивать.

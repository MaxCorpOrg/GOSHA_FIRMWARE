...
- `verify_flash` подтвердил совпадение обоих разделов с собранными файлами; 90 секунд наблюдения по UART прошли без паники, сторожевого таймера и повторной загрузки.

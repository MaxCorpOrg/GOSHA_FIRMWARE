...
- Текущий сетевой блокер нового робота — отсутствие маршрута до публичного узла платформы после успешной настройки домашнего Wi-Fi; этот код прошивки его не маскирует.

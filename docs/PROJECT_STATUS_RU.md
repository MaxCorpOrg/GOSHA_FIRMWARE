...
- Каноническая сборка `gosha-v1` через `scripts/release.py` прошла; на устройство изменения ещё не устанавливались.
- SHA-256 `firmware/build/gosha.bin`: `98ca593b7035f20b583280542841bc52fab2d467e4f2a00b1cb338644744a333`.
- SHA-256 `firmware/build/merged-binary.bin`: `90b44015d70baacaade2d87d08e47efab3ed6aac0b0c065dd6e0cdbfb61d5b17`.
- SHA-256 `firmware/releases/v2.2.2_gosha-v1.zip`: `ba6db39571ce4ad6a879bf0c5f7ec21e1c8775d8b9ef79e3f20df7029600fabe`.
- Повторный reviewer ИИ-офиса `task-20260722T093653Z-read-only-runtime-triangle` не нашёл P0/P1/P2 и разрешил фиксацию и отправку ветки без прошивки устройства.

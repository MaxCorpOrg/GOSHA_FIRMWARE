...
- Контрольное окно UART 90 секунд прошло со стабильной свободной памятью, штатными сетевыми сеансами, без паники, сторожевого таймера и повторной загрузки.
- Следующий шаг — визуально подтвердить оттенок на матрице и проверить Wi-Fi, батарею, центральный статус и основные эмоции, затем повторить слово пробуждения и один голосовой диалог.

...
- После живой проверки `2026-08-23` физический сервопривод левой руки нового устройства или его кабель считаются неисправными. До замены и повторной аппаратной приёмки запрещены команды движения, последовательности сервоприводов и `self.otto.set_trim`.
- Статический firmware gate Draft PR `#24` на `7751a3ca326174d217536f6a8de7c09433c3e955` получил terminal `PASS` GPT-5.5/xhigh без P0/P1/P2; это не снимает аппаратный запрет и не разрешает установку образа.

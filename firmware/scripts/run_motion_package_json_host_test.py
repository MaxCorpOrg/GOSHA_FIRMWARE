#!/usr/bin/env python3
"""Build and run the host-only Motion Studio package JSON parser test."""
...
SRC = ROOT / "scripts/motion_package_json_host_test.cc"
...
BIN = BUILD_DIR / "motion_package_json_host_test"
